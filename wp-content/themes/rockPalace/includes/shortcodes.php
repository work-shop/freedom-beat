...
if($tab['link'] != '')
$content .= '<a href="'.$tab['link'] .'"><img alt="'. stripText($tab['title']) .'" style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. $tab['imageurl'] .'" title="'. stripText($tab['title']) .'"></a>';
else
$content .= '<img alt="'. stripText($tab['title']) .'" style="height:'.$tab['height'].'px;width:'.$tab['width'].'px" src="'. $tab['imageurl'] .'&amp;h='.$tab['height'].''. stripText($tab['title']) .'">';
