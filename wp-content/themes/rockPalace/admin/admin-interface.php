...
<div class="wrap" id="of_container">
  ...
  <form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
    <div id="header">
      <div class="logo">
        <h2>Rock Palace - Wordpress Theme</h2> 
      </div>
...
public static function optionsframework_uploader_function($id = 0,$std = '' ,$mod = '' ){
...
public static function optionsframework_slider_function($id = 0 ,$std = '',$oldorder = 0,$order = 0,$int = 0,$desc = false, $team = false, $nivo = false){
