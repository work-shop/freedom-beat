...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-rockPalace'),
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('&laquo; First','wp-rockPalace'),
		'last_text' => __('Last &raquo;','wp-rockPalace'),
		'next_text' => __('&raquo;','wp-rockPalace'),
		'prev_text' => __('&laquo;','wp-rockPalace'),
		'dotright_text' => __('...','wp-rockPalace'),
		'dotleft_text' => __('...','wp-rockPalace'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
