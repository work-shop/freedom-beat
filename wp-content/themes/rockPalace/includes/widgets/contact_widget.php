...
class contact extends WP_Widget {
	...
	function contact() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'contact-widget', __('Rock Palace Contact Widget', 'wp-rockPalace'), $widget_ops, '' );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'mail' ); ?>"><?php _e('Your email:', 'wp-rockPalace') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tel_mob' ); ?>"><?php _e('Your mobile telephone number:', 'wp-rockPalace') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'tel_local' ); ?>"><?php _e('Your local telephone number:', 'wp-rockPalace') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vcard' ); ?>"><?php _e('Your VCARD contact:', 'wp-rockPalace') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vcardlink' ); ?>"><?php _e('Your VCARD link:', 'wp-rockPalace') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'msn' ); ?>"><?php _e('Your MSN contact:', 'wp-rockPalace') ?></label>
